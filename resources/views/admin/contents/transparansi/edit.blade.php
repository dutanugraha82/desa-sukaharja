...
@section('content')
    <div class="container-fluid" style="height: 100vh">
        <div class="card p-3" style="height: 100%">
            ...
            <form action="/admin/transparansi/{{ $item->id }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('put')
            <div class="mb-3">
            ...
            <div class="my-4 d-flex">
                <a href="/admin/transparansi" class="btn btn-warning mr-3" style="width: 150px;">Kembali</a>
