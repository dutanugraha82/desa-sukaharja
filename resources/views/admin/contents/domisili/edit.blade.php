...
@section('content')
    <div class="container-fluid">
        ...
        <hr>
        <form action="/{{ auth()->user()->role }}/domisili-dalam/{{ $data->id }}" method="POST">
            @csrf
            @method('put')
            <div class="row">
            ...
            <br>
            <div class="mt-4">
                <a style="width: 70vw" href="/{{ auth()->user()->role }}/domisili-dalam" class="btn btn-warning">Kembali</a><br>
