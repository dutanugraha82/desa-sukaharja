        ...
        <hr>
            <div class="row">
                <div class="col-md-6 mb-5 mb-md-0">
                    ...
                    <label for="kewarganegaraan">Kewarganegaraan <sup class="text-danger">*</sup></label>
                    <div class="mb-3 input-group input-group-outline">
                        <input type="text" class="form-control" name="kewarganegaraan" value="{{ $data->kewarganegaraan }}" required readonly>
                    </div>
            ...
            <br>
            <div class="mt-4">
                <a style="width: 70vw" href="/{{ auth()->user()->role }}/domisili-dalam" class="d-block mx-auto btn btn-warning">Kembali</a><br>
                <a style="width: 70vw" href="/{{ auth()->user()->role }}/domisili-dalam/{{ $data->id }}/print" class="d-block mx-auto btn btn-primary">Cetak Surat</a><br>
            </div>
